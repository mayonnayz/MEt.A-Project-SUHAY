                    ...
                    >
                        ...
                        @forelse($donations as $donation)
                            ...
                            <div
                                ...
                                data-name="{{ strtolower($donation['ngo_name'] ?? '') }}"

                                data-description="{{ strtolower($donation['description'] ?? '') }}"

                                data-source="{{ strtolower($donation['source'] ?? '') }}"

                                data-type="{{ strtolower($type) }}"

                                data-reference="{{ strtolower($donation['reference_no'] ?? '') }}"
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <button
                                            ...
                                            data-ngo="{{ $donation['ngo_name'] ?? 'Unknown NGO' }}"

                                            data-type="{{ $type }}"

                                            data-description="{{ $donation['description'] ?? 'N/A' }}"

                                            data-amount="{{ $donation['amount'] ?? '' }}"

                                            data-unit="{{ $donation['unit'] ?? '' }}"

                                            data-source="{{ $donation['source'] ?? 'N/A' }}"

                                            data-reference="{{ $donation['reference_no'] ?? 'N/A' }}"
