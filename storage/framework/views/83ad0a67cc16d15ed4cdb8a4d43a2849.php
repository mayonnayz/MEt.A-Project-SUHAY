...
<form id="volunteerForm" method="POST" action="#">
   ...
   <h3>Address Information</h3>
    ...
    <input type="date" name="dob" max="<?php echo e(date('Y-m-d')); ?>"><br><br>
...
</html><?php /**PATH C:\sysands\MEt.A-Project-SUHAY-elisha\resources\views/volunteer-application-form.blade.php ENDPATH**/ ?>