...
<body class="bg-gray-100">
    ...
    <section class="bg-[#0e243a] text-white py-16 px-0">
        <div class="max-w-7xl mx-auto grid md:grid-cols-3 gap-10 text-center">
            ...
            <!-- MISSION -->
            <div>
                <img src="<?php echo e(asset('images/mission.png')); ?>" class="mx-auto mb-4 h-12">
            ...
            <!-- VISION -->
            <div>
                <img src="<?php echo e(asset('images/vision.png')); ?>" class="mx-auto mb-4 h-12">
            ...
            <!-- VALUES -->
            <div>
                <img src="<?php echo e(asset('images/values.png')); ?>" class="mx-auto mb-4 h-12">
...
</html><?php /**PATH C:\sysands\MEt.A-Project-SUHAY-main\MEt.A-Project-SUHAY-main\resources\views/about_us.blade.php ENDPATH**/ ?>