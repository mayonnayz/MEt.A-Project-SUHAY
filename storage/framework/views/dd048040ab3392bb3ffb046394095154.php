...
<div class="flex">
    ...
    <div class="bg-[#4a5568] text-white rounded-2xl p-6 text-center 
        ...
        <div class="text-xs mt-4 text-left space-y-1 bg-[#3b4252] p-3 rounded-lg">
            ...
            <p><span class="font-semibold">Role:</span> <?php echo e($volunteer->roles); ?></p>
...
</html><?php /**PATH C:\sysands\MEt.A-Project-SUHAY-elisha\resources\views/ServiceManagement.blade.php ENDPATH**/ ?>