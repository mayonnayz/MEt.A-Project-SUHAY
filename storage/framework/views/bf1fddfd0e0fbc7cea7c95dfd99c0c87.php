...
<div class="group w-28 hover:w-56 bg-[#0e243a] min-h-screen flex flex-col py-6 text-white rounded-r-3xl transition-all duration-300 overflow-hidden">
    ...
    <?php if(in_array($role, ['ngo head', 'donation manager'])): ?>
        <a href="/inventory-master-list"
           class="flex items-center gap-4 px-4 py-4 rounded-xl mx-2 <?php echo e(navActive('inventory-master-list')); ?>">
    ...
    <?php if(in_array($role, ['ngo head', 'donation manager', 'volunteer manager'])): ?>
        ...
        <?php if(in_array($role, ['ngo head', 'donation manager'])): ?>
            <a href="/donations"
               class="flex items-center gap-4 px-4 py-4 rounded-xl mx-2
               <?php echo e(request()->is('donations') ? $active : $inactive); ?>">
                <img src="<?php echo e(asset('images/ServiceManagement/SMDonations.png')); ?>" class="w-16 h-16 object-contain">
                <span class="opacity-0 group-hover:opacity-100">Donations</span>
            </a>
        <?php endif; ?>
    ...
    <?php if($role === 'volunteer'): ?>
        ...
        class="flex items-center gap-4 px-4 py-4 rounded-xl mx-2
        <?php echo e(request()->is('volunteer/ngos') ? $active : $inactive); ?>">
        ...
        class="flex items-center gap-4 px-4 py-4 rounded-xl mx-2
        <?php echo e(request()->is('volunteer/donationhistory') ? $active : $inactive); ?>">

            <img src="<?php echo e(asset('images/VolunteerIcons/VDonations.png')); ?>" class="w-16 h-16 object-contain">
            <span class="opacity-0 group-hover:opacity-100">Donations</span>
        </a>
...
</div><?php /**PATH C:\sysands\MEt.A-Project-SUHAY-main\MEt.A-Project-SUHAY-main\resources\views/components/nav.blade.php ENDPATH**/ ?>