...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('images/suhayLogo.png')); ?>">
...
<section class="relative h-[280px] w-full" data-aos="fade-up" data-aos-duration="1000">
    <img src="<?php echo e(asset('images/hero.jpg')); ?>" class="w-full h-full object-cover">
...
<div class="max-w-4xl mx-auto px-6">
    ...
    <div onclick="openModal(<?php echo e($ngo['id']); ?>)"
        ...
        <div class="flex items-center gap-6">
            ...
            <div class="w-16 h-16 md:w-20 md:h-20 flex items-center justify-center">
                ...
                <?php if(!empty($ngo['logo'])): ?>
                    <img src="https://vqywnoljhhcnybzbvhhh.supabase.co/storage/v1/object/public/profile-pictures/<?php echo e($ngo['logo']); ?>"
            ...
            <div>
                ...
                <p class="text-base text-gray-600 mt-1">
                    <?php echo e($ngo['contact_number'] ?? 'No contact'); ?> • <?php echo e($ngo['address'] ?? 'No address'); ?>
...
function openModal(id) {
    ...
    <div class="text-center mb-6">
        <img src="${ngo.logo ? ngo.logo : '<?php echo e(asset('images/suhayLogo.png')); ?>'}" 
...
</html><?php /**PATH C:\sysands\MEt.A-Project-SUHAY-main\MEt.A-Project-SUHAY-main\resources\views/donate.blade.php ENDPATH**/ ?>