        ...
        <div class="bg-[#f5f5f5] rounded-[22px] border-[10px] border-[#0e243a] p-6 sm:p-8">
            ...
            <div id="donationList" class="space-y-5">
                ...
                <div class="donation-card rounded-2xl border-2 border-[#0e243a] bg-white p-5 
                    ...
                    data-name="<?php echo e(strtolower($donation->name ?? 'unknown')); ?>"
                    data-type="<?php echo e(strtolower($donation->type ?? 'monetary')); ?>">

                    <div>
                        <div class="text-lg font-bold text-[#0e243a]">
                            <?php echo e($donation->name ?? 'Unknown NGO'); ?>

                        </div>

                        <div class="flex items-center gap-2 text-sm text-gray-600 mt-1">
                            <img src="<?php echo e(asset('images/VolunteerIcons/DVDateIcon.png')); ?>" class="w-8 h-8">
                            <?php echo e(\Carbon\Carbon::parse($donation->date)->format('F d, Y')); ?>

                        </div>

                        <div class="flex items-center gap-2 text-sm text-gray-600">
                            <img src="<?php echo e(asset('images/VolunteerIcons/DVTypeIcon.png')); ?>" class="w-8 h-8">
                            <?php echo e(ucfirst($donation->type ?? 'Monetary')); ?>
                    ...
                    <div class="flex flex-col gap-2">
                        <button class="px-5 py-2 rounded-full bg-[#d4a017] text-white font-bold text-sm view-donation-btn hover:bg-[#c2870d] transition"
                                data-donation-type="<?php echo e(ucfirst($donation->type ?? 'Monetary')); ?>"
                                data-channel="<?php echo e(ucfirst($donation->payment_type ?? 'N/A')); ?>"
                                data-reference="<?php echo e($donation->reference_number ?? 'N/A'); ?>"
                                data-date="<?php echo e(\Carbon\Carbon::parse($donation->date)->format('F d, Y')); ?>"
                                data-items="<?php echo e(is_string($donation->donation_items) ? json_encode(json_decode($donation->donation_items)) : json_encode($donation->donation_items ?? [])); ?>"
                                data-ngo-name="<?php echo e(($donation->ngo->name ?? 'Unknown NGO')); ?>">
                            View Donation
                        </button>
                    </div>
...
<div id="donationModalBackdrop" class="fixed inset-0 bg-black/60 hidden items-center justify-center z-50 p-4">
  <div id="donationModalContent" class="bg-white rounded-2xl shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto">
    ...
    <div class="p-6 text-center relative border-b">
      ...
      <img src="<?php echo e(asset('images/suhayLogo.png')); ?>" class="h-12 mx-auto mb-3">
        ...
        content += `
            <div class="border rounded-xl p-4 bg-gray-50">
                <div class="font-bold text-[#0e243a] mb-4 flex items-center gap-2 text-sm">
                    <img src="<?php echo e(asset('images/VolunteerIcons/DVTypeIcon.png')); ?>" class="w-5 h-5">
                    Donated Items
                </div>
...
</html><?php /**PATH C:\sysands\MEt.A-Project-SUHAY\resources\views/Volunteers/donationhistory.blade.php ENDPATH**/ ?>