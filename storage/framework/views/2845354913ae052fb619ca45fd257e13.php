...
<div class="flex min-h-screen">
    ...
    <a
        href="<?php echo e(route('inventory.master')); ?>"
        class="bg-[#f2c94c]
               hover:bg-[#e5bb35]
               text-[#0e243a]
               px-6 py-2
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <tbody
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $movements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <tr
                                ...
                                data-movement-id="<?php echo e($movement->id); ?>"
                                ...
                                data-type="<?php echo e($movement->movement_type == 0
                                        ? 'inbound'
                                        : ($movement->movement_type == 1
                                            ? 'outbound'
                                            : 'pending')); ?>"

                                data-date="<?php echo e($movement->date_updated); ?>"

                                onclick="openMovementDetails(<?php echo \Illuminate\Support\Js::from($movement)->toHtml() ?>)"
                            >
                                ...
                                <td
                                    ...
                                    <?php echo e($movements->firstItem() + $loop->index); ?>
                                ...
                                <td class="py-4 px-4">
                                    ...
                                    <div class="font-semibold text-[#0e243a]">
                                        ...
                                        <?php echo e(\Carbon\Carbon::parse($movement->date_updated)->format('M d, Y')); ?>
                                ...
                                <td class="py-4 px-4">
                                    ...
                                    <?php if($movement->movement_type == 0): ?>
                                    ...
                                    <?php elseif($movement->movement_type == 1): ?>
                                ...
                                <td class="py-4 px-4">
                                    ...
                                    <span class="font-semibold text-gray-700">
                                        ...
                                        <?php echo e($movement->items->count()); ?>
                                    ...
                                    <span class="text-gray-400">
                                        ...
                                        item<?php echo e($movement->items->count() != 1 ? 's' : ''); ?>
                                ...
                                <td
                                    ...
                                    <?php echo e($movement->items->sum('quantity')); ?>
                                ...
                                <td class="py-4 px-4">
                                    ...
                                    <div class="text-gray-700">
                                        ...
                                        <?php echo e($movement->account->name ?? 'Unknown User'); ?>
            ...
            <div
                ...
                <div class="text-sm text-gray-500">
                    ...
                    <span class="font-semibold text-gray-700">
                        <?php echo e($movements->firstItem() ?? 0); ?>
                    ...
                    <span class="font-semibold text-gray-700">
                        <?php echo e($movements->lastItem() ?? 0); ?>
...
<div
    ...
    <div
        ...
        <form
            action="<?php echo e(route('inventory.movement.store')); ?>"
            method="POST">
...
<script src="<?php echo e(asset('js/inventory-movement.js')); ?>"></script>
