...
<body class="bg-gray-100">
    ...
    <!-- =========================================================
         PAGE CONTENT
         Only this section will fade/slide.
         Navbar will NOT be affected.
         ========================================================= -->
        ...
        <section class="bg-[#0e243a] text-white py-16 px-0">
            ...
            <div class="max-w-7xl mx-auto grid md:grid-cols-3 gap-10 text-center">
                ...
                <div>
                    ...
                    <img
                        src="<?php echo e(asset('images/mission.png')); ?>"
                ...
                <div>
                    ...
                    <img
                        src="<?php echo e(asset('images/vision.png')); ?>"
                        class="mx-auto mb-4 h-12"
                    >
                ...
                <div>
                    ...
                    <img
                        src="<?php echo e(asset('images/values.png')); ?>"
                        class="mx-auto mb-4 h-12"
                    >
...
</html><?php /**PATH C:\ProjectSuhay\MEt.A-Project-SUHAY\resources\views/about_us.blade.php ENDPATH**/ ?>