                        ...
                        <p class="text-lg font-semibold">
                            Active Events:
                                <span class="text-[#f2c94c]">
                                    <?php echo e(collect($events)->where('status', 1)->count()); ?>
                                ...
                                <td class="p-3 border">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <button 
                                            ...
                                            data-activities='<?php echo json_encode($event["activities"] ?? [], 15, 512) ?>'
                                        ...
                                        <?php if($event['status'] == 1): ?>
                                            ...
                                            <form method="POST" action="/events/<?php echo e($event['id']); ?>/archive" class="inline">
                                                <?php echo csrf_field(); ?>
                                        ...
                                        <?php else: ?>
                                            <form method="POST" action="/events/<?php echo e($event['id']); ?>/reactivate" class="inline">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('PUT'); ?>
...
</html><?php /**PATH C:\sysands\MEt.A-Project-SUHAY-main\MEt.A-Project-SUHAY-main\resources\views/events.blade.php ENDPATH**/ ?>