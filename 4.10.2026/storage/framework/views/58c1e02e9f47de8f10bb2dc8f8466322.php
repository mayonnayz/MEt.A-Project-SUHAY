...
<div class="flex">
    ...
    <div class="group w-28 hover:w-56 bg-[#0e243a] min-h-screen flex flex-col py-6 text-white rounded-r-3xl transition-all duration-300 overflow-hidden">
        ...
        <!-- ✅ FIXED: Changed to onclick instead of direct link -->
    ...
    <div class="flex-1 p-8">
        ...
        <div class="bg-[#0e243a] p-4 rounded-2xl flex gap-4 mb-6 flex-wrap">
            <a href="/service-management"
            class="bg-[#f2c94c] px-6 py-2 rounded-full font-normal font-sans text-base">
                Volunteer Lists
            </a>
            ...
            <a href="/assignments"
            class="bg-gray-200 text-[#0e243a] px-6 py-2 rounded-full font-normal font-sans text-base">
                Assignments
            </a>
...
<!-- ✅ LOGOUT MODAL (MOVED TO CORRECT POSITION - BEFORE </body>) -->
...
<!-- ✅ SCRIPT (CORRECT POSITION - BEFORE </body>) -->
<script>
...
</html><?php /**PATH C:\xampp\htdocs\example-app\MEt.A-Project-SUHAY\resources\views/assignments.blade.php ENDPATH**/ ?>