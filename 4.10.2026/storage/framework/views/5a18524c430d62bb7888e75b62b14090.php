                ...
                <table class="w-full text-center border border-gray-400">
                    ...
                    <tbody>
                        <tr class="bg-white border hover:bg-gray-100">
                            ...
                            <td class="p-3 border">Zyann Lynn Mayo</td>
                            <td class="p-3 border">Pending</td>
                            <td class="p-3 border space-x-2">
                                <button onclick="openModal()" class="bg-yellow-500 px-4 py-1 rounded-full">View</button>
                                <button class="bg-green-500 px-4 py-1 rounded-full text-white">Approve</button>
                                <button class="bg-red-500 px-4 py-1 rounded-full text-white">Reject</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
...
</html><?php /**PATH C:\xampp\htdocs\example-app\MEt.A-Project-SUHAY\resources\views/applications.blade.php ENDPATH**/ ?>