                            ...
                            @foreach ($donations as $index => $donation)
                                <tr class="hover:bg-slate-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 font-medium text-slate-800">
                                       {{ $donation->account->first_name . ' ' . $donation->account->last_name ?? 'Unknown'  }}
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <button 
                                            ...
                                            data-name="{{ $donation->account->first_name }} {{ $donation->account->last_name }}"
                                            data-date="{{ $donation->date->format('Y-m-d') }}"
