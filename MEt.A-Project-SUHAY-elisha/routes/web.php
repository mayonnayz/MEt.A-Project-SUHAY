...
Route::prefix('volunteer')->group(function () {
    ...
    Route::get('/donationhistory', [donation_controller::class, 'history']);
});

Route::post('/volunteer/update-profile-picture', [volunteer_controller::class, 'updateProfilePicture']);
